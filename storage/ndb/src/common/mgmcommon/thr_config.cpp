  ...
  Uint32 & recv_threads)
{
  ...
  static const struct entry
  {
    ...
    { 4, 0, 0, 2, 2, 1, 1 }, // 8-9 CPUs
    { 5, 0, 0, 5, 2, 1, 2 }, // 10-11 CPUs
    { 6, 1, 0, 6, 2, 1, 2 }, // 12-13 CPUs
    { 7, 1, 0, 7, 3, 1, 2 }, // 14-15 CPUs
    { 8, 1, 0, 8, 4, 1, 2 }, // 16-17 CPUs
    { 9, 1, 0, 9, 5, 1, 2 }, // 18-19 CPUs
    { 10, 1, 1, 10, 5, 1, 2 }, // 20-21 CPUs
    { 11, 1, 1, 11, 4, 2, 3 }, // 22-23 CPUs
    { 12, 1, 1, 12, 5, 2, 3 }, // 24-25 CPUs
    { 13, 1, 1, 13, 5, 2, 4 }, // 26-27 CPUs
    { 14, 1, 1, 14, 6, 2, 4 }, // 28-29 CPUs
    { 15, 1, 1, 15, 7, 2, 4 }, // 30-31 CPUs
    { 16, 1, 1, 16, 8, 2, 4 }, // 32-35 CPUs
    { 17, 1, 1, 18, 9, 2, 5 }, // 36-39 CPUs
    { 18, 1, 1, 20, 10, 3, 5 }, // 40-43 CPUs
    { 19, 1, 1, 22, 11, 3, 6 }, // 44-47 CPUs
    { 20, 1, 1, 24, 12, 4, 6 }, // 48-51 CPUs
    { 21, 1, 1, 26, 13, 4, 7 }, // 52-55 CPUs
    { 22, 1, 1, 28, 14, 5, 7 }, // 56-59 CPUs
    { 23, 1, 1, 30, 15, 5, 8 }, // 60-63 CPUs
    { 24, 1, 1, 32, 16, 6, 8 }, // 64-71 CPUs
    { 25, 1, 1, 36, 18, 7, 9 }, // 72-79 CPUs
    { 26, 1, 1, 40, 20, 8, 10 }, // 80-87 CPUs
    { 27, 1, 1, 44, 22, 9, 11 }, // 88-95 CPUs
    { 28, 1, 1, 48, 24, 10, 12 }, // 96-103 CPUs
    { 29, 1, 1, 52, 26, 11, 13 }, // 104-111 CPUs
    { 30, 1, 1, 56, 28, 12, 14 }, // 112-119 CPUs
    { 31, 1, 1, 60, 30, 13, 15 }, // 120-127 CPUs
    { 32, 1, 1, 64, 32, 14, 16 }, // 128-139 CPUs
    { 33, 1, 1, 70, 35, 15, 18 }, // 140-151 CPUs
    { 34, 1, 1, 76, 38, 17, 19 }, // 152-163 CPUs
    { 35, 1, 1, 82, 41, 18, 21 }, // 164-175 CPUs
    { 36, 1, 1, 88, 44, 20, 22 }, // 176-187 CPUs
    { 37, 1, 1, 94, 47, 21, 24 }, // 188-199 CPUs
    { 38, 1, 1, 100, 50, 23, 25 }, // 200-211 CPUs
    { 39, 1, 1, 106, 53, 24, 27 }, // 212-223 CPUs
    { 40, 1, 1, 112, 56, 26, 28 }, // 224-239 CPUs
    { 41, 1, 1, 120, 60, 28, 30 }, // 240-255 CPUs
    { 42, 1, 1, 128, 64, 30, 32 }, // 256-271 CPUs
    { 43, 1, 1, 136, 68, 32, 34 }, // 272-287 CPUs
    { 44, 1, 1, 144, 72, 34, 36 }, // 288-303 CPUs
    { 45, 1, 1, 152, 76, 36, 38 }, // 304-319 CPUs
    { 46, 1, 1, 80, 80, 38, 40 }, // 320-335 CPUs
    { 47, 1, 1, 168, 84, 40, 42 }, // 336-351 CPUs
    { 48, 1, 1, 176, 88, 42, 44 }, // 352-367 CPUs
    { 49, 1, 1, 184, 92, 44, 46 }, // 368-383 CPUs
    { 50, 1, 1, 192, 96, 46, 48 }, // 384-399 CPUs
    { 51, 1, 1, 200, 100, 48, 50 }, // 400-415 CPUs
    { 52, 1, 1, 208, 104, 50, 52 }, // 416-431 CPUs
    { 53, 1, 1, 216, 108, 52, 54 }, // 432-447 CPUs
    { 54, 1, 1, 224, 112, 54, 56 }, // 448-463 CPUs
    { 55, 1, 1, 232, 116, 56, 58 }, // 464-479 CPUs
    { 56, 1, 1, 240, 120, 58, 60 }, // 480-495 CPUs
    { 57, 1, 1, 248, 124, 60, 62 }, // 496-511 CPUs
    { 58, 1, 1, 256, 128, 62, 64 }, // 512-527 CPUs
    { 59, 1, 1, 264, 132, 64, 66 }, // 528-543 CPUs
    { 60, 1, 1, 272, 136, 66, 68 }, // 544-559 CPUs
    { 61, 1, 1, 280, 140, 68, 70 }, // 560-575 CPUs
    { 62, 1, 1, 288, 144, 70, 72 }, // 576-591 CPUs
    { 63, 1, 1, 296, 148, 72, 74 }, // 592-607 CPUs
    { 64, 1, 1, 304, 152, 74, 76 }, // 608-623 CPUs
    { 65, 1, 1, 312, 156, 76, 78 }, // 624-639 CPUs
    { 66, 1, 1, 320, 160, 78, 80 }, // 640-655 CPUs
    { 67, 1, 1, 328, 164, 80, 82 }, // 656-671 CPUs
    { 68, 1, 1, 336, 168, 82, 84 }, // 672-687 CPUs
    { 69, 1, 1, 344, 172, 84, 86 }, // 688-703 CPUs
    { 70, 1, 1, 352, 176, 86, 88 }, // 704-719 CPUs
    { 71, 1, 1, 360, 180, 88, 90 }, // 720-735 CPUs
    { 72, 1, 1, 368, 184, 90, 92 }, // 736-751 CPUs
    { 73, 1, 1, 376, 188, 92, 94 }, // 752-767 CPUs
    { 74, 1, 1, 384, 192, 94, 96 }, // 768-783 CPUs
    { 75, 1, 1, 392, 196, 96, 98 }, // 784-799 CPUs
    { 76, 1, 1, 400, 200, 98, 100 }, // 800-815 CPUs
    { 77, 1, 1, 408, 204, 100, 102 }, // 816-831 CPUs
    { 78, 1, 1, 416, 208, 102, 104 }, // 832-847 CPUs
    { 79, 1, 1, 424, 212, 104, 106 }, // 848-863 CPUs
    { 80, 1, 1, 432, 216, 106, 108 }, // 864-879 CPUs
    { 81, 1, 1, 440, 220, 108, 110 }, // 880-895 CPUs
    { 82, 1, 1, 448, 224, 110, 112 }, // 896-911 CPUs
    { 83, 1, 1, 456, 228, 112, 114 }, // 912-927 CPUs
  };
  Uint32 cpu_cnt;
  if (num_cpus == 0)
  {
