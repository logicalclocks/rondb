  ...
  Uint32 & recv_threads)
{
  ...
  static const struct entry
  {
    ...
    { 4, 0, 0, 4, 0, 1, 3 }, // 8-9 CPUs
    { 5, 1, 0, 4, 2, 1, 2 }, // 10-11 CPUs
    { 6, 1, 0, 5, 2, 1, 3 }, // 12-13 CPUs
    { 7, 1, 0, 6, 3, 1, 3 }, // 14-15 CPUs
    { 8, 1, 0, 7, 3, 1, 4 }, // 16-17 CPUs
    { 9, 1, 1, 8, 3, 1, 4 }, // 18-19 CPUs
    { 10, 1, 1, 9, 0, 2, 7 }, // 20-21 CPUs
    { 11, 1, 1, 10, 4, 2, 4 }, // 22-23 CPUs
    { 12, 1, 1, 11, 4, 2, 5 }, // 24-25 CPUs
    { 13, 1, 1, 12, 5, 2, 5 }, // 26-27 CPUs
    { 14, 1, 1, 13, 5, 2, 6 }, // 28-29 CPUs
    { 15, 1, 1, 14, 6, 2, 6 }, // 30-31 CPUs
    { 16, 1, 1, 14, 7, 2, 7 }, // 32-33 CPUs
    { 17, 1, 1, 15, 7, 3, 7 }, // 34-35 CPUs
    { 18, 1, 1, 16, 7, 3, 8 }, // 36-37 CPUs
    { 19, 1, 1, 17, 8, 3, 8 }, // 38-39 CPUs
    { 20, 1, 1, 18, 8, 3, 9 }, // 40-41 CPUs
    { 21, 1, 1, 19, 9, 3, 9 }, // 42-43 CPUs
    { 21, 1, 1, 20, 9, 3, 10 }, // 44-45 CPUs
    { 21, 1, 1, 21, 10, 3, 10 }, // 46-47 CPUs
    { 22, 1, 1, 22, 10, 3, 11 }, // 48
  };
  Uint32 cpu_cnt;
  if (num_cpus == 0)
  {
  ...
  if (cpu_cnt > 48)
  {
    main_threads = 1;
    rep_threads = 1;
    send_threads = ((cpu_cnt - 1) / 16) + 1;
    ldm_threads = (cpu_cnt - (send_threads + 2)) / 2;
    recv_threads = cpu_cnt - (send_threads + ldm_threads + 2);
    tc_threads = 0;
  }
  else
  {
