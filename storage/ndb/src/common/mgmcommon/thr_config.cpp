  ...
  Uint32 & recv_threads)
{
  ...
  static const struct entry
  {
    ...
    { 6, 1, 0, 5, 2, 2, 2 }, // 12-13 CPUs
    { 7, 1, 0, 6, 0, 2, 5 }, // 14-15 CPUs
    { 8, 1, 0, 7, 3, 2, 3 }, // 16-17 CPUs
    { 9, 1, 1, 8, 3, 2, 3 }, // 18-19 CPUs
    { 10, 1, 1, 9, 0, 2, 7 }, // 20-21 CPUs
    { 11, 1, 1, 10, 4, 2, 4 }, // 22-23 CPUs
    { 12, 1, 1, 11, 4, 3, 4 }, // 24-25 CPUs
    { 13, 1, 1, 12, 0, 3, 9 }, // 26-27 CPUs
    { 14, 1, 1, 13, 5, 3, 5 }, // 28-29 CPUs
    { 15, 1, 1, 14, 6, 3, 5 }, // 30-31 CPUs
    { 16, 1, 1, 14, 6, 4, 6 }, // 32-33 CPUs
    { 17, 1, 1, 15, 7, 4, 6 }, // 34-35 CPUs
    { 18, 1, 1, 16, 7, 4, 7 }, // 36-37 CPUs
    { 19, 1, 1, 17, 8, 4, 7 }, // 38-39 CPUs
    { 20, 1, 1, 18, 8, 4, 8 }, // 40-41 CPUs
    { 21, 1, 1, 19, 9, 4, 8 }, // 42-43 CPUs
    { 22, 1, 1, 20, 9, 5, 8 }, // 44
  };
  Uint32 cpu_cnt;
  if (num_cpus == 0)
