...
bool printBACKUP_REQ(FILE *output, const Uint32 *theData, Uint32 len,
                     Uint16 /*bno*/) {
...
bool printBACKUP_DATA(FILE *output, const Uint32 *theData, Uint32 len,
                      Uint16 /*bno*/) {
...
bool printBACKUP_REF(FILE *output, const Uint32 *theData, Uint32 len,
                     Uint16 /*bno*/) {
...
bool printBACKUP_CONF(FILE *output, const Uint32 *theData, Uint32 len,
                      Uint16 /*bno*/) {
...
bool printBACKUP_ABORT_REP(FILE *out, const Uint32 *data, Uint32 len,
                           Uint16 /*bno*/) {
...
bool printBACKUP_COMPLETE_REP(FILE *out, const Uint32 *data, Uint32 len,
                              Uint16 /*b*/) {
...
bool printBACKUP_NF_COMPLETE_REP(FILE *, const Uint32 *, Uint32, Uint16) {
  return false;
}

bool printABORT_BACKUP_ORD(FILE *out, const Uint32 *data, Uint32 len,
                           Uint16 /*b*/) {
