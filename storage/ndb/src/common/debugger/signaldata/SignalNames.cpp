...
const GsnName SignalNames[] = {
  ...
  ,{ GSN_JOIN_AGG_CANCEL_REQ, "JOIN_AGG_CANCEL_REQ" }
  ...
  ,{ GSN_JOIN_AGG_NULL_ROW_REF, "JOIN_AGG_NULL_ROW_REF" }
  ,{ GSN_CTE_LOOKUP_REQ, "CTE_LOOKUP_REQ" }
  ,{ GSN_CTE_LOOKUP_CONF, "CTE_LOOKUP_CONF" }
  ,{ GSN_CTE_LOOKUP_REF, "CTE_LOOKUP_REF" }
  ,{ GSN_JOIN_AGG_REDISTRIBUTE_REQ, "JOIN_AGG_REDISTRIBUTE_REQ" }
  ,{ GSN_JOIN_AGG_FINAL_REP, "JOIN_AGG_FINAL_REP" }
  ,{ GSN_JOIN_AGG_REDISTRIBUTE_CONF, "JOIN_AGG_REDISTRIBUTE_CONF" }
  ,{ GSN_JOIN_AGG_REDISTRIBUTE_REF, "JOIN_AGG_REDISTRIBUTE_REF" }
  ,{ GSN_CTE_SCAN_COMPLETE_REP, "CTE_SCAN_COMPLETE_REP" }
  ,{ GSN_CTE_START_MAIN_REQ, "CTE_START_MAIN_REQ" }
  ,{ GSN_CTE_PHASE_COMPLETE_REP, "CTE_PHASE_COMPLETE_REP" }
  ,{ GSN_CTE_PHASE_START_REQ, "CTE_PHASE_START_REQ" }
