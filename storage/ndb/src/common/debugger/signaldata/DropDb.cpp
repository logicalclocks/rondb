...
#define JAM_FILE_ID 561

bool printDROP_DB_REQ(FILE *output,
                      const Uint32 *theData,
                      Uint32 /* len */,
                      Uint16 /*receiverBlockNo*/)
{
  const DropDbReq *const sig = (const DropDbReq *)theData;
...
bool printDROP_DB_CONF(FILE *output,
                       const Uint32 *theData,
                       Uint32 /* len */,
                       Uint16 /*receiverBlockNo*/)
{
  const DropDbConf *const sig = (const DropDbConf *)theData;
  fprintf(output, " senderRef: H\'%.8x, senderData: %.8u\n", 
	  sig->senderRef, sig->senderData);
...
bool printDROP_DB_REF(FILE *output,
                      const Uint32 *theData,
                      Uint32 /* len */,
                      Uint16 /*receiverBlockNo*/)
{
  const DropDbRef *const sig = (const DropDbRef *)theData;
  fprintf(output, " senderRef: H\'%.8x, senderData: %.8u\n", 
	  sig->senderRef, sig->senderData);
  fprintf(output, " databaseId: %.8u\n", 
	  sig->databaseId);
