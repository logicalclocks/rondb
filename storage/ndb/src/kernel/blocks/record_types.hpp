 ...
 * Replication memory
 */
#define RG_REPLICATION_MEMORY   11
/**
 *
 */
...
/* 7 and 8 moved to RG_REPLICATION_MEMORY */
...
#define RT_DBLQH_MAP_FRAGMENT      MAKE_TID(34, RG_TRANSACTION_MEMORY)
...
#define RT_SUMA_SUBSCRIPTION_RECORD  MAKE_TID( 1, RG_SCHEMA_MEMORY)
#define RT_SUMA_SUB_OP_RECORD        MAKE_TID( 2, RG_SCHEMA_MEMORY)
#define RT_SUMA_TABLE_RECORD         MAKE_TID( 3, RG_SCHEMA_MEMORY)
#define RT_SUMA_SUBSCRIBER_RECORD    MAKE_TID( 4, RG_SCHEMA_MEMORY)
#define RT_SUMA_DATA_BUFFER          MAKE_TID( 5, RG_SCHEMA_MEMORY)
#define RT_PGMAN_FRAGMENTS           MAKE_TID( 6, RG_SCHEMA_MEMORY)
#define RT_DBDICT_OBJECT_RECORD      MAKE_TID( 7, RG_SCHEMA_MEMORY)
#define RT_DBDICT_FILE               MAKE_TID( 8, RG_SCHEMA_MEMORY)
#define RT_DBDICT_FILEGROUP          MAKE_TID( 9, RG_SCHEMA_MEMORY)
#define RT_DBDICT_TRIGGER_RECORD     MAKE_TID(10, RG_SCHEMA_MEMORY)
#define RT_DBDICT_TABLE_RECORD       MAKE_TID(11, RG_SCHEMA_MEMORY)
#define RT_DBDICT_ATTRIBUTE_RECORD   MAKE_TID(12, RG_SCHEMA_MEMORY)
#define RT_DBTC_INDEX_DATA           MAKE_TID(13, RG_SCHEMA_MEMORY)
#define RT_DBTC_DEFINED_TRIGGER      MAKE_TID(14, RG_SCHEMA_MEMORY)
#define RT_DBACC_FRAGMENT            MAKE_TID(15, RG_SCHEMA_MEMORY)
#define RT_DBTUP_FRAGMENT            MAKE_TID(16, RG_SCHEMA_MEMORY)
#define RT_DBLQH_FRAGMENT            MAKE_TID(17, RG_SCHEMA_MEMORY)
#define RT_DBTUX_FRAGMENT            MAKE_TID(18, RG_SCHEMA_MEMORY)
#define RT_DBTUP_TRIGGER_DATA        MAKE_TID(19, RG_SCHEMA_MEMORY)
#define RT_DBDIH_REPLICA             MAKE_TID(20, RG_SCHEMA_MEMORY)
#define RT_DBDIH_FRAGMENT            MAKE_TID(21, RG_SCHEMA_MEMORY)
