 ...
 */
#define RG_BACKUP_SCHEMA_MEMORY        11

/**
 * Replication memory
 */
#define RG_REPLICATION_MEMORY   12
/**
 *
 */
...
#define RT_DBLQH_MAP_FRAGMENT      MAKE_TID( 7, RG_TRANSACTION_MEMORY)
#define RT_DBTC_FRAG_LOCATION      MAKE_TID( 8, RG_TRANSACTION_MEMORY)
#define RT_DBTC_SCAN_FRAGMENT      MAKE_TID( 9, RG_TRANSACTION_MEMORY)
#define RT_DBTC_SCAN_RECORD        MAKE_TID(10, RG_TRANSACTION_MEMORY)
#define RT_DBTC_CONNECT_RECORD     MAKE_TID(11, RG_TRANSACTION_MEMORY)
#define RT_DBTC_COMMIT_ACK_MARKER  MAKE_TID(12, RG_TRANSACTION_MEMORY)
#define RT_DBTC_INDEX_OPERATION    MAKE_TID(13, RG_TRANSACTION_MEMORY)
#define RT_DBTC_API_CONNECT_RECORD MAKE_TID(14, RG_TRANSACTION_MEMORY)
#define RT_DBTC_API_CONNECT_TIMERS MAKE_TID(15, RG_TRANSACTION_MEMORY)
#define RT_DBTC_CACHE_RECORD       MAKE_TID(16, RG_TRANSACTION_MEMORY)
#define RT_DBTC_GCP_RECORD         MAKE_TID(17, RG_TRANSACTION_MEMORY)
#define RT_DBTC_FIRED_TRIGGER_DATA MAKE_TID(18, RG_TRANSACTION_MEMORY)
#define RT_DBTC_ATTRIBUTE_BUFFER   MAKE_TID(19, RG_TRANSACTION_MEMORY)
#define RT_DBTC_COMMIT_ACK_MARKER_BUFFER MAKE_TID(20, RG_TRANSACTION_MEMORY)
#define RT_DBLQH_TC_CONNECT        MAKE_TID(21, RG_TRANSACTION_MEMORY)
#define RT_DBLQH_COMMIT_ACK_MARKER MAKE_TID(22, RG_TRANSACTION_MEMORY)
#define RT_DBLQH_SCAN_RECORD       MAKE_TID(23, RG_TRANSACTION_MEMORY)
#define RT_DBTUP_OPERATION         MAKE_TID(24, RG_TRANSACTION_MEMORY)
#define RT_DBTUP_STORED_PROCEDURE  MAKE_TID(25, RG_TRANSACTION_MEMORY)
#define RT_DBTUP_SCAN_OPERATION    MAKE_TID(26, RG_TRANSACTION_MEMORY)
#define RT_DBTUP_SCAN_LOCK         MAKE_TID(27, RG_TRANSACTION_MEMORY)
#define RT_DBACC_SCAN              MAKE_TID(28, RG_TRANSACTION_MEMORY)
#define RT_DBACC_OPERATION         MAKE_TID(29, RG_TRANSACTION_MEMORY)
#define RT_DBTUX_SCAN_OPERATION    MAKE_TID(30, RG_TRANSACTION_MEMORY)
#define RT_DBTUX_SCAN_LOCK         MAKE_TID(31, RG_TRANSACTION_MEMORY)
#define RT_DBTUX_SCAN_BOUND        MAKE_TID(32, RG_TRANSACTION_MEMORY)
...
#define RT_SUMA_EVENT_BUFFER         MAKE_TID( 1, RG_REPLICATION_MEMORY)
#define RT_SUMA_TRIGGER_BUFFER       MAKE_TID( 2, RG_REPLICATION_MEMORY)

#define RT_PGMAN_FRAGMENTS           MAKE_TID( 1, RG_SCHEMA_MEMORY)
#define RT_DBDICT_OBJECT_RECORD      MAKE_TID( 2, RG_SCHEMA_MEMORY)
#define RT_DBDICT_FILE               MAKE_TID( 3, RG_SCHEMA_MEMORY)
#define RT_DBDICT_FILEGROUP          MAKE_TID( 4, RG_SCHEMA_MEMORY)
#define RT_DBDICT_TRIGGER_RECORD     MAKE_TID( 5, RG_SCHEMA_MEMORY)
#define RT_DBDICT_TABLE_RECORD       MAKE_TID( 6, RG_SCHEMA_MEMORY)
#define RT_DBDICT_ATTRIBUTE_RECORD   MAKE_TID( 7, RG_SCHEMA_MEMORY)
#define RT_DBTC_INDEX_DATA           MAKE_TID( 8, RG_SCHEMA_MEMORY)
#define RT_DBTC_DEFINED_TRIGGER      MAKE_TID( 9, RG_SCHEMA_MEMORY)
#define RT_DBACC_FRAGMENT            MAKE_TID(10, RG_SCHEMA_MEMORY)
#define RT_DBTUP_FRAGMENT            MAKE_TID(11, RG_SCHEMA_MEMORY)
#define RT_DBLQH_FRAGMENT            MAKE_TID(12, RG_SCHEMA_MEMORY)
#define RT_DBTUX_FRAGMENT            MAKE_TID(13, RG_SCHEMA_MEMORY)
#define RT_DBDIH_REPLICA             MAKE_TID(14, RG_SCHEMA_MEMORY)
#define RT_DBDIH_FRAGMENT            MAKE_TID(15, RG_SCHEMA_MEMORY)
#define RT_DBTUX_DESC_PAGE           MAKE_TID(16, RG_SCHEMA_MEMORY)
#define RT_SUMA_SUBSCRIPTION_RECORD  MAKE_TID(17, RG_REPLICATION_MEMORY)
#define RT_SUMA_SUB_OP_RECORD        MAKE_TID(18, RG_REPLICATION_MEMORY)
#define RT_SUMA_TABLE_RECORD         MAKE_TID(19, RG_REPLICATION_MEMORY)
#define RT_SUMA_SUBSCRIBER_RECORD    MAKE_TID(20, RG_REPLICATION_MEMORY)
#define RT_SUMA_DATA_BUFFER          MAKE_TID(21, RG_REPLICATION_MEMORY)

#define RT_DBTUP_TRIGGER_DATA        MAKE_TID(1, RG_BACKUP_SCHEMA_MEMORY)
#define RT_BACKUP_DELETE_LCP         MAKE_TID(2, RG_BACKUP_SCHEMA_MEMORY)
#define RT_BACKUP_TRIGGER            MAKE_TID(3, RG_BACKUP_SCHEMA_MEMORY)
