...
void Dbtup::convertThPage(Fix_page *regPagePtr, Tablerec *regTabPtr,
                          Uint32 mm) {
...
Uint32 Dbtup::alloc_tuple_from_page(Fragrecord *const regFragPtr,
...
void Dbtup::free_fix_rec(Fragrecord *regFragPtr, Tablerec *regTabPtr,
  ...
  } else if (free == (Fix_page::DATA_WORDS /
