...
static const HoleSymbolEntry kHoleSymbolTable[] = {
  ...
  /* op_min_bigint / op_max_bigint (Phase 5B, shared holes) */
  { "HOLE_MM_SLOT",   HK_OP_A },
  { "HOLE_MM_SRC",    HK_OP_B },
  { "HOLE_MM_RESULT", HK_OP_C },
  ...
  /* Phase 7 cold-call comparison branch (BRANCH_ATTR_OP_ARG): the operand
   * hole carries the instruction's word offset (op->b), and the target is
   * an HK_BRANCH_TAKE — same shape as the attr-null branches above. */
  { "HOLE_BAOA_OFF",  HK_OP_B         },
  { "HOLE_BAOA_TGT",  HK_BRANCH_TAKE  },
  ...
  /* ronsql_jit slice 2 item 5: op_branch_mem_op_arg — instruction
  ...
  /* Phase 5D-2 f64/u64 null-branching load siblings. */
  { "HOLE_LFNB_COL",      HK_OP_B          },
  { "HOLE_LFNB_DST",      HK_OP_A          },
  { "HOLE_LFNB_TGT",      HK_BRANCH_TAKE   },
  { "HOLE_LUNB_COL",      HK_OP_B          },
  { "HOLE_LUNB_DST",      HK_OP_A          },
  { "HOLE_LUNB_TGT",      HK_BRANCH_TAKE   },
  /* Phase 5G op_load_col_ndb_dec — DECIMAL load. The packed
   * precision/scale/signedness word rides op->b. */
  ...
  /* Phase 5L op_divmod_conv. */
  { "HOLE_DMC_ARG",       HK_OP_C          },
};
...
/* Phase 5D-2 f64/u64 null-branching load helper arguments. */
#define MAGIC_LFNB_COL_NARROW     0x3f14u
#define MAGIC_LFNB_DST_NARROW     0x82ebu
#define MAGIC_LUNB_COL_NARROW     0xcabdu
#define MAGIC_LUNB_DST_NARROW     0x573du
/* Phase 5G op_load_col_ndb_dec helper arguments. */
...
/* Phase 5L op_divmod_conv packed helper argument. */
#define MAGIC_DMC_ARG_NARROW      0xc065u
...
/* Phase 5B: op_min_bigint / op_max_bigint (shared). */
...
static const HoleNarrowMagicEntry kHoleNarrowMagicTable[] = {
  ...
  /* Phase 5D-2: f64/u64 null-branching load helper arguments. */
  { MAGIC_LFNB_COL_NARROW,  HK_OP_B,  "MAGIC_LFNB_COL_NARROW"  },
  { MAGIC_LFNB_DST_NARROW,  HK_OP_A,  "MAGIC_LFNB_DST_NARROW"  },
  { MAGIC_LUNB_COL_NARROW,  HK_OP_B,  "MAGIC_LUNB_COL_NARROW"  },
  { MAGIC_LUNB_DST_NARROW,  HK_OP_A,  "MAGIC_LUNB_DST_NARROW"  },
  /* Phase 5G: op_load_col_ndb_dec helper arguments. */
  ...
  /* Phase 5L: op_divmod_conv packed helper argument. */
  { MAGIC_DMC_ARG_NARROW,   HK_OP_C,  "MAGIC_DMC_ARG_NARROW"   },
};
