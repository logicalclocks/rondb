...
static const uint8_t bytes_op_sum_bigint[] = {
  0xb8, 0x00, 0x00, 0x00, 0x00, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x8b,
  0x0c, 0xcc, 0x49, 0x01, 0x4c, 0xc4, 0x40, 
};
...
static const Hole holes_op_branch_attr_eq_null[] = {
  ...
  { .byte_offset = 15, .kind = HK_COLDCALL, .width = 4, .helper_name = "ndb_jit_h_branch_attr_null" },
  { .byte_offset = 25, .kind = HK_BRANCH_TAKE, .width = 4 },
  { .byte_offset = 31, .kind = HK_BRANCH_FALL, .width = 4 },
};

/* op_branch_attr_ne_null — 32 bytes, 4 holes */
static const uint8_t bytes_op_branch_attr_ne_null[] = {
  0x50, 0xbe, 0x00, 0x00, 0x00, 0x00, 0x4c, 0x89, 0xe7, 0x31, 0xd2, 0xe8,
  0x00, 0x00, 0x00, 0x00, 0x85, 0xc0, 0x74, 0x06, 0x58, 0xe9, 0x00, 0x00,
  0x00, 0x00, 0x58, 0xe9, 0x00, 0x00, 0x00, 0x00, 
};
static const Hole holes_op_branch_attr_ne_null[] = {
  { .byte_offset = 2, .kind = HK_OP_B, .width = 4 },
  { .byte_offset = 12, .kind = HK_COLDCALL, .width = 4, .helper_name = "ndb_jit_h_branch_attr_null" },
  { .byte_offset = 22, .kind = HK_BRANCH_TAKE, .width = 4 },
  { .byte_offset = 28, .kind = HK_BRANCH_FALL, .width = 4 },
};

/* op_load_linked_to_mem — 15 bytes, 2 holes */
static const uint8_t bytes_op_load_linked_to_mem[] = {
  0x50, 0xbe, 0x00, 0x00, 0x00, 0x00, 0x4c, 0x89, 0xe7, 0xe8, 0x00, 0x00,
  0x00, 0x00, 0x58, 
};
static const Hole holes_op_load_linked_to_mem[] = {
  { .byte_offset = 2, .kind = HK_OP_B, .width = 4 },
  { .byte_offset = 10, .kind = HK_COLDCALL, .width = 4, .helper_name = "ndb_jit_h_read_linked_to_mem" },
};

/* op_branch_linked_eq_null — 30 bytes, 3 holes */
static const uint8_t bytes_op_branch_linked_eq_null[] = {
  0x50, 0x4c, 0x89, 0xe7, 0xbe, 0x01, 0x00, 0x00, 0x00, 0xe8, 0x00, 0x00,
  0x00, 0x00, 0x85, 0xc0, 0x74, 0x06, 0x58, 0xe9, 0x00, 0x00, 0x00, 0x00,
  0x58, 0xe9, 0x00, 0x00, 0x00, 0x00, 
};
static const Hole holes_op_branch_linked_eq_null[] = {
  { .byte_offset = 10, .kind = HK_COLDCALL, .width = 4, .helper_name = "ndb_jit_h_branch_linked_null" },
  { .byte_offset = 20, .kind = HK_BRANCH_TAKE, .width = 4 },
  { .byte_offset = 26, .kind = HK_BRANCH_FALL, .width = 4 },
};

/* op_branch_linked_ne_null — 27 bytes, 3 holes */
static const uint8_t bytes_op_branch_linked_ne_null[] = {
  0x50, 0x4c, 0x89, 0xe7, 0x31, 0xf6, 0xe8, 0x00, 0x00, 0x00, 0x00, 0x85,
  0xc0, 0x74, 0x06, 0x58, 0xe9, 0x00, 0x00, 0x00, 0x00, 0x58, 0xe9, 0x00,
  0x00, 0x00, 0x00, 
};
static const Hole holes_op_branch_linked_ne_null[] = {
  { .byte_offset = 7, .kind = HK_COLDCALL, .width = 4, .helper_name = "ndb_jit_h_branch_linked_null" },
  { .byte_offset = 17, .kind = HK_BRANCH_TAKE, .width = 4 },
  { .byte_offset = 23, .kind = HK_BRANCH_FALL, .width = 4 },
};
