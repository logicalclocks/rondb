...
static const uint8_t bytes_op_load_col_int[] = {
  0x49, 0x8b, 0x84, 0x24, 0x80, 0x00, 0x00, 0x00, 0xb9, 0x00, 0x00, 0x00,
  0x00, 0x48, 0x8b, 0x04, 0xc8, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x89,
  0x04, 0xcc,
};
static const Hole holes_op_load_col_int[] = {
  { .byte_offset = 9, .kind = HK_OP_B, .width = 4 },
  { .byte_offset = 18, .kind = HK_OP_A, .width = 4 },
};
...
/* op_sum_bigint — 39 bytes, 3 holes */
static const uint8_t bytes_op_sum_bigint[] = {
  0xb8, 0x00, 0x00, 0x00, 0x00, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x8b,
  0x0c, 0xcc, 0x49, 0x01, 0x8c, 0xc4, 0xa0, 0x00, 0x00, 0x00, 0xb8, 0x00,
  0x00, 0x00, 0x00, 0x49, 0xc7, 0x84, 0xc4, 0xa0, 0x01, 0x00, 0x00, 0x01,
  0x00, 0x00, 0x00,
};
static const Hole holes_op_sum_bigint[] = {
  { .byte_offset = 1, .kind = HK_OP_A, .width = 4 },
  { .byte_offset = 6, .kind = HK_OP_B, .width = 4 },
  { .byte_offset = 23, .kind = HK_OP_C, .width = 4 },
};

/* op_count_bigint — 42 bytes, 2 holes */
static const uint8_t bytes_op_count_bigint[] = {
  0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0xff, 0x84, 0xc4, 0xa0, 0x00, 0x00,
  0x00, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0xc7, 0x84, 0xc4, 0xa0, 0x01,
  0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x49, 0xc7, 0x84, 0xc4, 0xa0, 0x02,
  0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
};
static const Hole holes_op_count_bigint[] = {
  { .byte_offset = 1, .kind = HK_OP_A, .width = 4 },
  { .byte_offset = 14, .kind = HK_OP_C, .width = 4 },
};

/* op_min_bigint — 82 bytes, 5 holes */
static const uint8_t bytes_op_min_bigint[] = {
  0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0x8b, 0x04, 0xc4, 0xb9, 0x00, 0x00,
  0x00, 0x00, 0x49, 0x83, 0xbc, 0xcc, 0xa0, 0x03, 0x00, 0x00, 0x00, 0x74,
  0x0f, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x3b, 0x84, 0xcc, 0xa0, 0x00,
  0x00, 0x00, 0x7d, 0x0d, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x89, 0x84,
  0xcc, 0xa0, 0x00, 0x00, 0x00, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0xc7,
  0x84, 0xc4, 0xa0, 0x03, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x49, 0xc7,
  0x84, 0xc4, 0xa0, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
};
static const Hole holes_op_min_bigint[] = {
  { .byte_offset = 1, .kind = HK_OP_B, .width = 4 },
  { .byte_offset = 10, .kind = HK_OP_C, .width = 4 },
  { .byte_offset = 26, .kind = HK_OP_A, .width = 4 },
  { .byte_offset = 41, .kind = HK_OP_A, .width = 4 },
  { .byte_offset = 54, .kind = HK_OP_C, .width = 4 },
};

/* op_max_bigint — 82 bytes, 5 holes */
static const uint8_t bytes_op_max_bigint[] = {
  0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0x8b, 0x04, 0xc4, 0xb9, 0x00, 0x00,
  0x00, 0x00, 0x49, 0x83, 0xbc, 0xcc, 0xa0, 0x03, 0x00, 0x00, 0x00, 0x74,
  0x0f, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x3b, 0x84, 0xcc, 0xa0, 0x00,
  0x00, 0x00, 0x7e, 0x0d, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x89, 0x84,
  0xcc, 0xa0, 0x00, 0x00, 0x00, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0xc7,
  0x84, 0xc4, 0xa0, 0x03, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x49, 0xc7,
  0x84, 0xc4, 0xa0, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
};
...
/* op_sum_bigint_checked — 59 bytes, 5 holes */
static const uint8_t bytes_op_sum_bigint_checked[] = {
  0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0x8b, 0x8c, 0xc4, 0xa0, 0x00, 0x00,
  0x00, 0xba, 0x00, 0x00, 0x00, 0x00, 0x49, 0x03, 0x0c, 0xd4, 0x71, 0x05,
  0xe9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x89, 0x8c, 0xc4, 0xa0, 0x00, 0x00,
  0x00, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0xc7, 0x84, 0xc4, 0xa0, 0x01,
  0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0xe9, 0x00, 0x00, 0x00, 0x00,
};
static const Hole holes_op_sum_bigint_checked[] = {
  { .byte_offset = 1, .kind = HK_OP_A, .width = 4 },
  { .byte_offset = 14, .kind = HK_OP_B, .width = 4 },
  { .byte_offset = 25, .kind = HK_OVERFLOW_TAKE, .width = 4 },
  { .byte_offset = 38, .kind = HK_OP_C, .width = 4 },
  { .byte_offset = 55, .kind = HK_BRANCH_FALL, .width = 4 },
};
...
static const uint8_t bytes_op_div_f64[] = {
  ...
  0xc7, 0x84, 0x24, 0x98, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x31,
...
/* op_sum_f64 — 149 bytes, 7 holes */
static const uint8_t bytes_op_sum_f64[] = {
  ,
};
static const Hole holes_op_sum_f64[] = {
  ...
  { .byte_offset = 10, .kind = HK_OP_C, .width = 4 },
  { .byte_offset = 26, .kind = HK_OP_A, .width = 4 },
  { .byte_offset = 79, .kind = HK_OVERFLOW_TAKE, .width = 4 },
  { .byte_offset = 89, .kind = HK_OP_A, .width = 4 },
  { .byte_offset = 104, .kind = HK_OP_C, .width = 4 },
  { .byte_offset = 145, .kind = HK_BRANCH_FALL, .width = 4 },
};

/* op_min_f64 — 105 bytes, 5 holes */
static const uint8_t bytes_op_min_f64[] = {
  0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0x8b, 0x04, 0xc4, 0xb9, 0x00, 0x00,
  0x00, 0x00, 0x49, 0x83, 0xbc, 0xcc, 0xa0, 0x03, 0x00, 0x00, 0x00, 0x74,
  0x1a, 0x66, 0x48, 0x0f, 0x6e, 0xc0, 0xb9, 0x00, 0x00, 0x00, 0x00, 0xf2,
  0x41, 0x0f, 0x10, 0x8c, 0xcc, 0xa0, 0x00, 0x00, 0x00, 0x66, 0x0f, 0x2e,
  0xc8, 0x76, 0x0d, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x89, 0x84, 0xcc,
  0xa0, 0x00, 0x00, 0x00, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0xc7, 0x84,
  0xc4, 0xa0, 0x03, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x49, 0xc7, 0x84,
  0xc4, 0xa0, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x49, 0xc7, 0x84,
  0xc4, 0xa0, 0x04, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
};
static const Hole holes_op_min_f64[] = {
  ...
  { .byte_offset = 65, .kind = HK_OP_C, .width = 4 },
};

/* op_max_f64 — 101 bytes, 5 holes */
static const uint8_t bytes_op_max_f64[] = {
  0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0x8b, 0x04, 0xc4, 0xb9, 0x00, 0x00,
  0x00, 0x00, 0x49, 0x83, 0xbc, 0xcc, 0xa0, 0x03, 0x00, 0x00, 0x00, 0x74,
  0x16, 0x66, 0x48, 0x0f, 0x6e, 0xc0, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x66,
  0x41, 0x0f, 0x2e, 0x84, 0xcc, 0xa0, 0x00, 0x00, 0x00, 0x76, 0x0d, 0xb9,
  0x00, 0x00, 0x00, 0x00, 0x49, 0x89, 0x84, 0xcc, 0xa0, 0x00, 0x00, 0x00,
  0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0xc7, 0x84, 0xc4, 0xa0, 0x03, 0x00,
  0x00, 0x01, 0x00, 0x00, 0x00, 0x49, 0xc7, 0x84, 0xc4, 0xa0, 0x01, 0x00,
  0x00, 0x01, 0x00, 0x00, 0x00, 0x49, 0xc7, 0x84, 0xc4, 0xa0, 0x04, 0x00,
...
static const Hole holes_op_max_f64[] = {
  ...
  { .byte_offset = 61, .kind = HK_OP_C, .width = 4 },
};
...
/* op_sum_u64_checked — 71 bytes, 5 holes */
static const uint8_t bytes_op_sum_u64_checked[] = {
  0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0x8b, 0x8c, 0xc4, 0xa0, 0x00, 0x00,
  0x00, 0xba, 0x00, 0x00, 0x00, 0x00, 0x49, 0x03, 0x0c, 0xd4, 0x73, 0x05,
  0xe9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x89, 0x8c, 0xc4, 0xa0, 0x00, 0x00,
  0x00, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0xc7, 0x84, 0xc4, 0xa0, 0x01,
  0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x49, 0xc7, 0x84, 0xc4, 0xa0, 0x02,
  0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0xe9, 0x00, 0x00, 0x00, 0x00,
...
static const Hole holes_op_sum_u64_checked[] = {
  ...
  { .byte_offset = 25, .kind = HK_OVERFLOW_TAKE, .width = 4 },
  { .byte_offset = 38, .kind = HK_OP_C, .width = 4 },
  { .byte_offset = 67, .kind = HK_BRANCH_FALL, .width = 4 },
};

/* op_min_u64 — 94 bytes, 5 holes */
static const uint8_t bytes_op_min_u64[] = {
  0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0x8b, 0x04, 0xc4, 0xb9, 0x00, 0x00,
  0x00, 0x00, 0x49, 0x83, 0xbc, 0xcc, 0xa0, 0x03, 0x00, 0x00, 0x00, 0x74,
  0x0f, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x3b, 0x84, 0xcc, 0xa0, 0x00,
  0x00, 0x00, 0x73, 0x0d, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x89, 0x84,
  0xcc, 0xa0, 0x00, 0x00, 0x00, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0xc7,
  0x84, 0xc4, 0xa0, 0x03, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x49, 0xc7,
  0x84, 0xc4, 0xa0, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x49, 0xc7,
  0x84, 0xc4, 0xa0, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
};
...
/* op_max_u64 — 94 bytes, 5 holes */
static const uint8_t bytes_op_max_u64[] = {
  0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0x8b, 0x04, 0xc4, 0xb9, 0x00, 0x00,
  0x00, 0x00, 0x49, 0x83, 0xbc, 0xcc, 0xa0, 0x03, 0x00, 0x00, 0x00, 0x74,
  0x0f, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x3b, 0x84, 0xcc, 0xa0, 0x00,
  0x00, 0x00, 0x76, 0x0d, 0xb9, 0x00, 0x00, 0x00, 0x00, 0x49, 0x89, 0x84,
  0xcc, 0xa0, 0x00, 0x00, 0x00, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x49, 0xc7,
  0x84, 0xc4, 0xa0, 0x03, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x49, 0xc7,
  0x84, 0xc4, 0xa0, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x49, 0xc7,
  0x84, 0xc4, 0xa0, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
...
static const uint8_t bytes_op_div_int_checked[] = {
  ...
  0x48, 0x85, 0xc9, 0x0f, 0x94, 0xc2, 0x41, 0x09, 0x94, 0x24, 0x98, 0x00,
...
static const uint8_t bytes_op_mod_int[] = {
  ...
  0x41, 0x09, 0x94, 0x24, 0x98, 0x00, 0x00, 0x00, 0x48, 0x83, 0xf9, 0x01,
...
static const uint8_t bytes_op_div_u64[] = {
  ...
  0x94, 0xc2, 0x41, 0x09, 0x94, 0x24, 0x98, 0x00, 0x00, 0x00, 0x48, 0x83,
...
/* op_set_reg_null_fb — 12 bytes, 0 holes */
...
/* op_branch_mem_op_arg — 37 bytes, 4 holes */
...
static const Hole holes_op_branch_mem_op_arg[] = {
  { .byte_offset = 2, .kind = HK_OP_B, .width = 4 },
  { .byte_offset = 11, .kind = HK_COLDCALL, .width = 8, .helper_name = "ndb_jit_h_branch_mem_op_arg" },
  { .byte_offset = 27, .kind = HK_BRANCH_TAKE, .width = 4 },
  { .byte_offset = 33, .kind = HK_BRANCH_FALL, .width = 4 },
};

/* op_branch_f64 — 37 bytes, 4 holes */
...
static const Hole holes_op_branch_f64[] = {
  ...
  { .byte_offset = 11, .kind = HK_COLDCALL, .width = 8, .helper_name = "ndb_jit_h_branch_f64" },
  { .byte_offset = 27, .kind = HK_BRANCH_TAKE, .width = 4 },
  { .byte_offset = 33, .kind = HK_BRANCH_FALL, .width = 4 },
};

/* op_read_mem_to_reg — 27 bytes, 3 holes */
