...
/* 46 is ZNSL_REPORT in released 25.10 (on an id conflict the lower
 * version always wins): ZCONTINUE_JOIN_AGG_SEND moved 46 -> 61 in the
 * 26.10 merge of 2026-09-18. */
#define ZCONTINUE_JOIN_AGG_SEND 61
