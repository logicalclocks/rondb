  ...
  Uint32 & recv_threads)
{
  ...
  static const struct entry
  {
    ...
    { 11, 1, 1, 6, 6, 4, 1, 3 }, // 22-23 CPUs
    { 12, 1, 1, 6, 6, 5, 2, 3 }, // 24-25 CPUs
    { 13, 1, 1, 7, 7, 5, 2, 3 }, // 26-27 CPUs
    { 14, 1, 1, 8, 8, 5, 2, 3 }, // 28-29 CPUs
    { 15, 1, 1, 8, 8, 6, 2, 4 }, // 30-31 CPUs
    { 16, 1, 1, 9, 9, 6, 2, 4 }, // 32-35 CPUs
    { 17, 1, 1, 10, 10, 7, 3, 4 }, // 36-39 CPUs
    { 18, 1, 1, 12, 12, 7, 3, 4 }, // 40-43 CPUs
    { 19, 1, 1, 13, 13, 8, 4, 4 }, // 44-47 CPUs
    { 20, 1, 1, 14, 14, 9, 4, 5 }, // 48-51 CPUs
    { 21, 1, 1, 15, 15, 10, 4, 6 }, // 52-55 CPUs
    { 22, 1, 1, 17, 17, 10, 4, 6 }, // 56-59 CPUs
    { 23, 1, 1, 18, 18, 11, 5, 6 }, // 60-63 CPUs
    { 24, 1, 1, 19, 19, 12, 5, 7 }, // 64-71 CPUs
    { 25, 1, 1, 21, 21, 14, 6, 8 }, // 72-79 CPUs
    { 26, 1, 1, 24, 24, 16, 6, 8 }, // 80-87 CPUs
    { 27, 1, 1, 26, 26, 18, 7, 9 }, // 88-95 CPUs
    { 28, 1, 1, 29, 29, 20, 7, 9 }, // 96-103 CPUs
    { 29, 1, 1, 31, 31, 22, 8, 10 }, // 104-111 CPUs
    { 30, 1, 1, 34, 34, 23, 8, 11 }, // 112-119 CPUs
    { 31, 1, 1, 36, 36, 25, 9, 12 }, // 120-127 CPUs
    { 32, 1, 1, 39, 39, 27, 9, 12 }, // 128-139 CPUs
    { 33, 1, 1, 43, 43, 30, 9, 13 }, // 140-151 CPUs
    { 34, 1, 1, 47, 47, 32, 10, 14 }, // 152-163 CPUs
    { 35, 1, 1, 51, 51, 34, 11, 15 }, // 164-175 CPUs
    { 36, 1, 1, 55, 55, 36, 12, 16 }, // 176-187 CPUs
    { 37, 1, 1, 59, 59, 38, 13, 17 }, // 188-199 CPUs
    { 38, 1, 1, 63, 63, 40, 14, 18 }, // 200-211 CPUs
    { 39, 1, 1, 67, 67, 42, 15, 19 }, // 212-223 CPUs
    { 40, 1, 1, 72, 72, 43, 15, 20 }, // 224-239 CPUs
    { 41, 1, 1, 77, 77, 47, 16, 21 }, // 240-255 CPUs
    { 42, 1, 1, 82, 82, 50, 17, 23 }, // 256-271 CPUs
    { 43, 1, 1, 87, 87, 54, 18, 24 }, // 272-287 CPUs
    { 44, 1, 1, 92, 92, 57, 19, 26 }, // 288-303 CPUs
    { 45, 1, 1, 97, 97, 61, 20, 27 }, // 304-319 CPUs
    { 46, 1, 1, 102, 102, 64, 21, 29 }, // 320-335 CPUs
    { 47, 1, 1, 107, 107, 68, 22, 30 }, // 336-351 CPUs
    { 48, 1, 1, 112, 112, 71, 23, 32 }, // 352-367 CPUs
    { 49, 1, 1, 117, 117, 75, 24, 33 }, // 368-383 CPUs
    { 50, 1, 1, 122, 122, 78, 25, 35 }, // 384-399 CPUs
    { 51, 1, 1, 127, 127, 82, 26, 36 }, // 400-415 CPUs
    { 52, 1, 1, 132, 132, 85, 27, 38 }, // 416-431 CPUs
    { 53, 1, 1, 137, 137, 89, 28, 39 }, // 432-447 CPUs
    { 54, 1, 1, 142, 142, 92, 29, 41 }, // 448-463 CPUs
    { 55, 1, 1, 147, 147, 96, 30, 42 }, // 464-479 CPUs
    { 56, 1, 1, 152, 152, 99, 31, 44 }, // 480-495 CPUs
    { 57, 1, 1, 157, 157, 103, 32, 45 }, // 496-511 CPUs
    { 58, 1, 1, 162, 162, 106, 33, 47 }, // 512-527 CPUs
    { 59, 1, 1, 167, 167, 110, 34, 48 }, // 528-543 CPUs
    { 60, 1, 1, 172, 172, 113, 35, 50 }, // 544-559 CPUs
    { 61, 1, 1, 177, 177, 117, 36, 51 }, // 560-575 CPUs
    { 62, 1, 1, 182, 182, 120, 37, 53 }, // 576-591 CPUs
    { 63, 1, 1, 187, 187, 124, 38, 54 }, // 592-607 CPUs
    { 64, 1, 1, 192, 192, 127, 39, 56 }, // 608-623 CPUs
    { 65, 1, 1, 197, 197, 131, 40, 57 }, // 624-639 CPUs
    { 66, 1, 1, 202, 202, 134, 41, 59 }, // 640-655 CPUs
    { 67, 1, 1, 207, 207, 138, 42, 60 }, // 656-671 CPUs
    { 68, 1, 1, 212, 212, 141, 43, 62 }, // 672-687 CPUs
    { 69, 1, 1, 217, 217, 145, 44, 63 }, // 688-703 CPUs
    { 70, 1, 1, 222, 222, 148, 45, 65 }, // 704-719 CPUs
    { 71, 1, 1, 227, 227, 152, 46, 66 }, // 720-735 CPUs
    { 72, 1, 1, 232, 232, 155, 47, 68 }, // 736-751 CPUs
    { 73, 1, 1, 237, 237, 159, 48, 69 }, // 752-767 CPUs
    { 74, 1, 1, 242, 242, 162, 49, 71 }, // 768-783 CPUs
    { 75, 1, 1, 247, 247, 166, 50, 72 }, // 784-799 CPUs
    { 76, 1, 1, 252, 252, 169, 51, 74 }, // 800-815 CPUs
    { 77, 1, 1, 257, 257, 173, 52, 75 }, // 816-831 CPUs
    { 78, 1, 1, 262, 262, 176, 53, 77 }, // 832-847 CPUs
    { 79, 1, 1, 267, 267, 180, 54, 78 }, // 848-863 CPUs
    { 80, 1, 1, 272, 272, 183, 55, 80 }, // 864-879 CPUs
    { 81, 1, 1, 277, 277, 187, 56, 81 }, // 880-895 CPUs
    { 82, 1, 1, 282, 282, 190, 57, 83 }, // 896-911 CPUs
    { 83, 1, 1, 287, 287, 194, 58, 84 }, // 912-927 CPUs
  };
  Uint32 cpu_cnt;
