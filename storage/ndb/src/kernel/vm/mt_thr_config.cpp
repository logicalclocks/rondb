  ...
  Uint32 & recv_threads)
{
  ...
  static const struct entry
  {
    ...
    { 28, 1, 1, 24, 24, 20, 10, 13 }, // 96-103 CPUs
    { 29, 1, 1, 26, 26, 21, 11, 15 }, // 104-111 CPUs
    { 30, 1, 1, 28, 28, 21, 12, 16 }, // 112-119 CPUs
    { 31, 1, 1, 30, 30, 22, 13, 17 }, // 120-127 CPUs
    { 32, 1, 1, 32, 32, 24, 13, 18 }, // 128-139 CPUs
    { 33, 1, 1, 35, 35, 26, 14, 21 }, // 140-151 CPUs
    { 34, 1, 1, 38, 38, 28, 15, 23 }, // 152-163 CPUs
    { 35, 1, 1, 41, 41, 30, 16, 25 }, // 164-175 CPUs
    { 36, 1, 1, 44, 44, 32, 17, 27 }, // 176-187 CPUs
    { 37, 1, 1, 47, 47, 35, 18, 29 }, // 188-199 CPUs
    { 38, 1, 1, 50, 50, 37, 19, 31 }, // 200-211 CPUs
    { 39, 1, 1, 53, 53, 39, 20, 33 }, // 212-223 CPUs
    { 40, 1, 1, 56, 56, 41, 21, 35 }, // 224-239 CPUs
    { 41, 1, 1, 60, 60, 44, 22, 38 }, // 240-255 CPUs
    { 42, 1, 1, 64, 64, 48, 23, 40 }, // 256-271 CPUs
    { 43, 1, 1, 68, 68, 51, 25, 42 }, // 272-287 CPUs
    { 44, 1, 1, 72, 72, 54, 26, 45 }, // 288-303 CPUs
    { 45, 1, 1, 76, 76, 58, 27, 47 }, // 304-319 CPUs
    { 46, 1, 1, 80, 80, 61, 29, 49 }, // 320-335 CPUs
    { 47, 1, 1, 84, 84, 64, 30, 52 }, // 336-351 CPUs
    { 48, 1, 1, 88, 88, 68, 31, 54 }, // 352-367 CPUs
    { 49, 1, 1, 92, 92, 71, 33, 56 }, // 368-383 CPUs
    { 50, 1, 1, 96, 96, 74, 34, 59 }, // 384-399 CPUs
    { 51, 1, 1, 100, 100, 78, 35, 61 }, // 400-415 CPUs
    { 52, 1, 1, 104, 104, 81, 37, 63 }, // 416-431 CPUs
    { 53, 1, 1, 108, 108, 84, 38, 66 }, // 432-447 CPUs
    { 54, 1, 1, 112, 112, 88, 39, 68 }, // 448-463 CPUs
    { 55, 1, 1, 116, 116, 91, 41, 70 }, // 464-479 CPUs
    { 56, 1, 1, 120, 120, 94, 42, 73 }, // 480-495 CPUs
    { 57, 1, 1, 124, 124, 98, 43, 75 }, // 496-511 CPUs
    { 58, 1, 1, 128, 128, 101, 45, 77 }, // 512-527 CPUs
    { 59, 1, 1, 132, 132, 104, 46, 80 }, // 528-543 CPUs
    { 60, 1, 1, 136, 136, 108, 47, 82 }, // 544-559 CPUs
    { 61, 1, 1, 140, 140, 111, 49, 84 }, // 560-575 CPUs
    { 62, 1, 1, 144, 144, 114, 50, 87 }, // 576-591 CPUs
    { 63, 1, 1, 148, 148, 118, 51, 89 }, // 592-607 CPUs
    { 64, 1, 1, 152, 152, 121, 53, 91 }, // 608-623 CPUs
    { 65, 1, 1, 156, 156, 124, 54, 94 }, // 624-639 CPUs
    { 66, 1, 1, 160, 160, 128, 55, 96 }, // 640-655 CPUs
    { 67, 1, 1, 164, 164, 131, 57, 98 }, // 656-671 CPUs
    { 68, 1, 1, 168, 168, 134, 58, 101 }, // 672-687 CPUs
    { 69, 1, 1, 172, 172, 138, 59, 103 }, // 688-703 CPUs
    { 70, 1, 1, 176, 176, 141, 61, 105 }, // 704-719 CPUs
    { 71, 1, 1, 180, 180, 144, 62, 108 }, // 720-735 CPUs
    { 72, 1, 1, 184, 184, 148, 63, 110 }, // 736-751 CPUs
    { 73, 1, 1, 188, 188, 151, 65, 112 }, // 752-767 CPUs
    { 74, 1, 1, 192, 192, 154, 66, 115 }, // 768-783 CPUs
    { 75, 1, 1, 196, 196, 158, 67, 117 }, // 784-799 CPUs
    { 76, 1, 1, 200, 200, 161, 69, 119 }, // 800-815 CPUs
    { 77, 1, 1, 204, 204, 164, 70, 122 }, // 816-831 CPUs
    { 78, 1, 1, 208, 208, 168, 71, 124 }, // 832-847 CPUs
    { 79, 1, 1, 212, 212, 171, 73, 126 }, // 848-863 CPUs
    { 80, 1, 1, 216, 216, 174, 74, 129 }, // 864-879 CPUs
    { 81, 1, 1, 220, 220, 178, 75, 131 }, // 880-895 CPUs
    { 82, 1, 1, 224, 224, 181, 77, 133 }, // 896-911 CPUs
    { 83, 1, 1, 228, 228, 184, 78, 136 }, // 912-927 CPUs
  };
  Uint32 cpu_cnt;
