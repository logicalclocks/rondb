...
ErrorBundle ErrorCodes[] = {
  ...
  { 20009, DMEC, AE, "Query aborted due to query node too big" },
  { 20010, DMEC, AE, "Query aborted due to query node parameters too big" },
  ...
  { 1274, DMEC, TR, "Join aggregation setup not received in time, parked request aborted" },
  { 1275, DMEC, TR, "Out of join aggregation park or identity records in LQH" },
  ...
  { 1272, DMEC, AE, "Single-row CTE materialized more than one row" },
  { 1273, DMEC, AE, "Single-group CTE materialized more than one group" },
  ...
  { 1870,  DMEC, TR, "Failed to allocate memory, check error log on data node for more details" },
