			...
			int forceSend)
{
  ...
  do {
    ...
    do
    {
      ...
      const bool have_pending_ops = (theFirstOpInList != NULL);
      const bool exec_now =
    ...
    assert((theFirstOpInList == NULL && nextBatchOps.isEmpty()) ||
           tExecType == NoCommit);
