...
- `cte_filter_phase_n.md` — Phase N (planned final wrap-up): closes or explicitly defers the last RONDB-1050 catalogue items: I.25 string CTE query failures and comparison matrix, I.13 SQL-facing batch-size control, I.14 early close / LIMIT interaction for CTE scans, and I.15 multi-fragment / multi-node CTE behaviour coverage
