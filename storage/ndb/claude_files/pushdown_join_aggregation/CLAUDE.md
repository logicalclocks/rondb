...
- `cte_filter_phase_i18.md` — Phase I.18: typed leaf-column register loads for embedded col-vs-col conditions; fixes signed sub-Bigint leaf values currently zero-extended by READ_ATTR_INTO_REG
