...
| **D20** | multi-key CTE complete-key lookup (any predicate order) | `JOIN x ON x.k1=.. AND x.k2=..` over a 2-col virt-PK CTE (J14/J15) |
...
| **D12** | CTE-body signed-int col-vs-col over orders | RonSQLRetryableError after 10 attempts ("Integer type column…") |
