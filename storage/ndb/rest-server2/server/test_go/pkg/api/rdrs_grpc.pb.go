...
type RonDBRESTClient interface {
	...
	Health(ctx context.Context, in *HealthRequestProto, opts ...grpc.CallOption) (*HealthResponseProto, error)
}
...
func (c *ronDBRESTClient) Health(ctx context.Context, in *HealthRequestProto, opts ...grpc.CallOption) (*HealthResponseProto, error) {
	out := new(HealthResponseProto)
	err := c.cc.Invoke(ctx, "/grpcserver.v1.RonDBREST/Health", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RonDBRESTServer interface {
	...
	Health(context.Context, *HealthRequestProto) (*HealthResponseProto, error)
...
func (UnimplementedRonDBRESTServer) Health(context.Context, *HealthRequestProto) (*HealthResponseProto, error) {
...
func _RonDBREST_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HealthRequestProto)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RonDBRESTServer).Health(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpcserver.v1.RonDBREST/Health",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RonDBRESTServer).Health(ctx, req.(*HealthRequestProto))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RonDBREST_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Health",
			Handler:    _RonDBREST_Health_Handler,
		},
	},
