...
//#define DEBUG_STAT_CTRL 1
#endif

#ifdef DEBUG_STAT_CTRL
#define DEB_STAT_CTRL(...) do { g_eventLogger->info(__VA_ARGS__); } while (0)
#else
#define DEB_STAT_CTRL(...) do { } while (0)
#endif

void HealthCtrl::stat(
