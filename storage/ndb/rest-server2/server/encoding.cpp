...
void create_native_request(PKReadParams& pkReadParams,	void* reqBuff, void* respBuff) {
...
std::string process_pkread_response(void* respBuff,	PKReadResponseJSON& response) {
