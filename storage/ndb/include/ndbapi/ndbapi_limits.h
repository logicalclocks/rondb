...
#define OLD_NDB_MAX_ATTRIBUTES_IN_TABLE 512
#define NDB_MAX_ATTRIBUTES_IN_TABLE 4096

#define NDB_MAX_TUPLE_SIZE_IN_WORDS 18000
#define NDB_MAX_VAR_SIZE_IN_WORDS 8000
#define NDB_MAX_VAR_SIZE (NDB_MAX_VAR_SIZE_IN_WORDS * 4)
