...
#define NDB_PARTITION_BALANCE_FOR_RP_BY_LDM_X_2    ~Uint32(8)
#define NDB_PARTITION_BALANCE_FOR_RP_BY_LDM_X_4    ~Uint32(9)
#define NDB_PARTITION_BALANCE_FOR_RP_BY_LDM_X_6    ~Uint32(10)
