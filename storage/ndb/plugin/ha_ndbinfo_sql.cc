...
static struct view {
  ...
  { "ndbinfo", "pools",
    ...
    {"ndbinfo", "resources",
     ...
     "  WHEN 11 THEN \"BACKUP_SCHEMA_MEMORY\""
     "  WHEN 12 THEN \"REPLICATION_MEMORY\""
     "  ELSE \"<unknown>\" "
    ...
    {"ndbinfo", "table_info",
     ...
     " WHEN 4294967287 THEN \"FOR_RP_BY_LDM_X_2\""
     " WHEN 4294967286 THEN \"FOR_RP_BY_LDM_X_4\""
     " WHEN 4294967285 THEN \"FOR_RP_BY_LDM_X_6\""
     " WHEN 4294967284 THEN \"FOR_RP_BY_LDM_X_8\""
     " WHEN 4294967283 THEN \"FOR_RP_BY_LDM_X_16\""
     " ELSE \"Invalid value\""
