...
VALUES
    (
        33, NULL, 'id1', NULL, 0, 2069, 1, 2059
    ),
    (
        26, NULL, 'id1', NULL, 0, 2071, 1, 2060
    ),
    (
        30, 'fg2_', 'id1', 'id1', 1, 2071, 0, 2061
    ),
    (
        29, NULL, 'id1', NULL, 0, 2069, 1, 2061
    ),
    (
        58, NULL, 'id1', NULL, 0, 2068, 1, 2064
    ),
    (
        59, 'fg2_', 'id1', 'id1', 1, 2068, 0, 2065
    ),
    (
        60, NULL, 'id1', NULL, 0, 2072, 1, 2065
    ),
    (
        21, 'fg2_', 'id1', 'id1', 1, 2068, 0, 2066
    ),
    (
        20, NULL, 'id1', NULL, 0, 2069, 1, 2066
    ),
    (
        25, NULL, 'id2', NULL, 0, 2076, 1, 2079
    ),
    (
        24, NULL, 'id1', NULL, 0, 2076, 1, 2079
    ),
    (
        32, 'fg1_', 'id1', 'id1', 1, 2070, 0, 2080
    ),
    (
        31, NULL, 'id1', NULL, 0, 2069, 1, 2080
    ),
    (
        22, NULL, 'id1', NULL, 0, 2076, 1, 2085
    ),
    (
        23, NULL, 'id2', NULL, 0, 2076, 1, 2085
    ),
    (
        61, NULL, 'id1', NULL, 0, 2072, 1, 2063
    ),
    (
        53, NULL, 'id2', NULL, 0, 2076, 1, 2078
    ),
    (
        52, NULL, 'id1', NULL, 0, 2076, 1, 2078
    ),
    (
        56, 'fg2_', 'id1', 'id1', 1, 2071, 0, 3082
    ),
    (
        57, NULL, 'id1', NULL, 0, 2069, 1, 3082
    ),
    (
        54, NULL, 'id1', NULL, 0, 2069, 0, 3083
    ),
    (
        55, 'fg2_', 'id1', 'id1', 1, 2071, 0, 3083
    ),
    (
        70, NULL, 'id1', NULL, 0, 3089, 1, 3086
    ),
    (
	    63, NULL, 'id1', NULL, 0, 2069, 1, 3087
    ),
    (
