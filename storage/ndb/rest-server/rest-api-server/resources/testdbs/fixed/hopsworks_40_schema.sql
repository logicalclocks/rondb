...
CREATE TABLE `environment_history` (
    ...
    PRIMARY KEY (`id`),
    KEY `environment_id` (`environment_id`),
    CONSTRAINT `history_environment_fk` FOREIGN KEY (`environment_id`) REFERENCES `environment` (`id`) ON DELETE CASCADE
) ENGINE=ndbcluster
  DEFAULT CHARSET = latin1
  COLLATE = latin1_general_cs;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
    ...
    `app_id`                varchar(255) COLLATE latin1_general_cs            DEFAULT NULL,
    ...
    `history_server_app_id` varchar(255) COLLATE latin1_general_cs            DEFAULT NULL,
    PRIMARY KEY (`id`),
...
(
    ...
    `for_log`                    tinyint(1)    NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `feature_group_descriptive_statistics`
...
CREATE TABLE IF NOT EXISTS `feature_view_descriptive_statistics`
...
CREATE TABLE IF NOT EXISTS `training_dataset_descriptive_statistics`
...
CREATE TABLE IF NOT EXISTS `test_dataset_descriptive_statistics`
...
CREATE TABLE IF NOT EXISTS `val_dataset_descriptive_statistics`
...
(
    ...
    CONSTRAINT `job_environment_fk` FOREIGN KEY (`environment_id`) REFERENCES `environment` (`id`) ON DELETE RESTRICT ON UPDATE NO ACTION
) ENGINE = ndbcluster
  AUTO_INCREMENT = 37
  DEFAULT CHARSET = latin1
  COLLATE = latin1_general_cs;
...
(
    ...
    CONSTRAINT `jupyter_environment_fk` FOREIGN KEY (`environment_id`) REFERENCES `environment` (`id`) ON DELETE RESTRICT ON UPDATE NO ACTION
) ENGINE = ndbcluster
  DEFAULT CHARSET = latin1
  COLLATE = latin1_general_cs;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `jupyter_spark_session`
--

/*!40101 SET @saved_cs_client = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jupyter_spark_session` (

    `id` int NOT NULL AUTO_INCREMENT,
    `jupyter_project_id` int NOT NULL,
    `application_id` varchar(255) NOT NULL COLLATE latin1_general_cs NOT NULL,
    `kernel_id` varchar(255) NOT NULL COLLATE latin1_general_cs NOT NULL,
    `port` int NOT NULL,
    PRIMARY KEY (`id`),
    KEY `fk_jupyter_project` (`jupyter_project_id`),
    UNIQUE KEY `kernel_id` (`kernel_id`),
    CONSTRAINT `fk_jupyter_project` FOREIGN KEY (`jupyter_project_id`) REFERENCES `jupyter_project` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE = ndbcluster
  DEFAULT CHARSET = latin1
  COLLATE = latin1_general_cs;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `environment` (
    ...
    `name`              varchar(128) COLLATE latin1_general_cs   DEFAULT NULL,
    `description`       varchar(1024) COLLATE latin1_general_cs  DEFAULT NULL,
    ...
    `base_image_id`     int(11)                                  NOT NULL,
    UNIQUE KEY `project_env_name` (`project_id`, `name`),
    PRIMARY KEY (`id`),
    CONSTRAINT `env_project_fk` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
    CONSTRAINT `base_image_fk` FOREIGN KEY (`base_image_id`) REFERENCES `base_image` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=ndbcluster
  DEFAULT CHARSET = latin1
  COLLATE = latin1_general_cs;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `environment_python_libraries`
--

/*!40101 SET @saved_cs_client = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `environment_python_libraries` (
    `environment_id`    int(11) NOT NULL,
    `python_library_id` int(11) NOT NULL,
    PRIMARY KEY (`environment_id`,`python_library_id`),
    KEY `python_library_id` (`python_library_id`),
    CONSTRAINT `environment_fk` FOREIGN KEY (`environment_id`) REFERENCES `environment` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
    CONSTRAINT `FK_505_514` FOREIGN KEY (`python_library_id`) REFERENCES `python_library` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=ndbcluster
  DEFAULT CHARSET = latin1
  COLLATE = latin1_general_cs
    /*!50100 PARTITION BY KEY (environment_id) */;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `python_library`
--
...
(
    ...
    CONSTRAINT `serving_environment_fk` FOREIGN KEY (`environment_id`) REFERENCES `environment` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE = ndbcluster
  DEFAULT CHARSET = latin1
  COLLATE = latin1_general_cs;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
    ...
    `feature_view_id`           INT(11)                                 NULL,
    `on_demand_transformation`  INT(11),
    PRIMARY KEY (`id`),
    ...
    CONSTRAINT `odtf_fk_fgtf` FOREIGN KEY (`on_demand_transformation`) REFERENCES  `feature_group_transformation_functions` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
(
    ...
    `training_dataset`        int(11)     NULL,
    `feature_group`           int(11)     NULL,
    `left_feature_group`      int(11)     NULL,
...
CREATE TABLE IF NOT EXISTS `hopsworks`.`feature_view_transformation_function` ( -- mapping transformation functions in feature view with required features and actual transformation function.
    `id`                                INT(11)         NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `feature_group_transformation_functions` ( -- mapping transformation functions in feature groups with required features and actual transformation function.
    `id`                                INT(11)         NOT NULL AUTO_INCREMENT,
    `transformation_function_id`        int(11)         NOT NULL,
    `feature_group_id`                  int(11)         NOT NULL,
    `features`                          VARCHAR(5004)   NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hopsworks`.`base_image` (
    `id` int AUTO_INCREMENT PRIMARY KEY,
    `name` varchar(128) COLLATE latin1_general_cs NOT NULL,
    `image_name` varchar(128) COLLATE latin1_general_cs NOT NULL,
    `image_tag` varchar(128) COLLATE latin1_general_cs NOT NULL,
    `description` varchar(1024) COLLATE latin1_general_cs DEFAULT NULL,
    `type` varchar(128) COLLATE latin1_general_cs NOT NULL,
    `preinstalled` tinyint(1) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS feature_view_logging
(
    id                  INT AUTO_INCREMENT PRIMARY KEY,
    feature_view_id     INT(11),
    transformed_fg_id   INT(11),
    untransformed_fg_id INT(11),
    CONSTRAINT `fvl_fv` FOREIGN KEY (`feature_view_id`) REFERENCES `hopsworks`.`feature_view` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
    CONSTRAINT `fvl_transformed_fg` FOREIGN KEY (`transformed_fg_id`) REFERENCES `hopsworks`.`feature_group` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION,
    CONSTRAINT `fvl_untransformed_fg` FOREIGN KEY (`untransformed_fg_id`) REFERENCES `hopsworks`.`feature_group` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE = ndbcluster
  DEFAULT CHARSET = latin1
  COLLATE = latin1_general_cs;
