...
id=65	@127.0.0.1  (RonDB-21.04.0)
id=66 (not connected, node is deactivated)

[mysqld(API)]	2 node(s)
id=67 (not connected, accepting connect from 127.0.0.1)
...
ERROR: Unable to connect with connect string: nodeid=0,127.0.0.1:1187
...
Node 66 now has hostname 127.0.0.1 in the cluster
...
[ndb_mgmd(MGM)]	2 node(s)
id=65	@127.0.0.1  (RonDB-21.04.0)
id=66	@127.0.0.1  (RonDB-21.04.0)

[mysqld(API)]	2 node(s)
id=67 (not connected, accepting connect from 127.0.0.1)
id=68 (not connected, node is deactivated)

## Connect to MGM server at 127.0.0.1:1187, node 66, deactivate node 65, expect success
...
---------------------
[ndbd(NDB)]	3 node(s)
id=1	@127.0.0.1  (RonDB-21.04.0, Nodegroup: 0, *)
id=2 (not connected, node is deactivated)
id=3 (not connected, node is deactivated)
...
Now changing hostname in the cluster
Node 2 now has hostname 127.0.0.1 in the cluster
...
[ndbd(NDB)]	3 node(s)
id=1	@127.0.0.1  (RonDB-21.04.0, Nodegroup: 0, *)
id=2	@127.0.0.1  (RonDB-21.04.0, Nodegroup: 0)
id=3 (not connected, node is deactivated)
...
[ndb_mgmd(MGM)]	2 node(s)
id=65 (not connected, accepting connect from 127.0.0.1)
id=66	@127.0.0.1  (RonDB-21.04.0)
...
Now changing hostname in the cluster
Node 3 now has hostname 127.0.0.1 in the cluster
...
Now changing hostname in the cluster
Node 68 now has hostname 127.0.0.1 in the cluster
...
[mysqld(API)]	2 node(s)
id=67 (not connected, accepting connect from 127.0.0.1)
id=68 (not connected, accepting connect from 127.0.0.1)
