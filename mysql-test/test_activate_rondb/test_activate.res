...
Connected to Management Server at: 192.168.0.102:1186
Cluster Configuration
---------------------
[ndbd(NDB)]	3 node(s)
id=1 (not connected, accepting connect from 192.168.0.102)
id=2 (not connected, node is deactivated)
id=3 (not connected, node is deactivated)

[ndb_mgmd(MGM)]	2 node(s)
id=65	@192.168.0.102  (RonDB-21.04.5)
id=66 (not connected, node is deactivated)

[mysqld(API)]	2 node(s)
id=67 (not connected, accepting connect from 192.168.0.102)
...
ERROR: Unable to connect with connect string: nodeid=0,192.168.0.102:1187
...
Node 66 now has hostname 192.168.0.102 in the cluster
...
[ndb_mgmd(MGM)]	2 node(s)
id=65	@192.168.0.102  (RonDB-21.04.5)
id=66	@192.168.0.102  (RonDB-21.04.5)

[mysqld(API)]	2 node(s)
id=67 (not connected, accepting connect from 192.168.0.102)
id=68 (not connected, node is deactivated)

## Connect to MGM server at 192.168.0.102:1187, node 66, deactivate node 65, expect success
Connected to Management Server at: 192.168.0.102:1187
...
---------------------
[ndbd(NDB)]	3 node(s)
id=1	@192.168.0.102  (RonDB-21.04.5, Nodegroup: 0, *)
id=2 (not connected, node is deactivated)
id=3 (not connected, node is deactivated)
...
Now changing hostname in the cluster
Node 2 now has hostname 192.168.0.102 in the cluster
...
[ndbd(NDB)]	3 node(s)
id=1	@192.168.0.102  (RonDB-21.04.5, Nodegroup: 0, *)
id=2	@192.168.0.102  (RonDB-21.04.5, Nodegroup: 0)
id=3 (not connected, node is deactivated)
...
[ndb_mgmd(MGM)]	2 node(s)
id=65 (not connected, accepting connect from 192.168.0.102)
id=66	@192.168.0.102  (RonDB-21.04.5)
...
Now changing hostname in the cluster
Node 3 now has hostname 192.168.0.102 in the cluster
...
Now changing hostname in the cluster
Node 68 now has hostname 192.168.0.102 in the cluster
...
[mysqld(API)]	2 node(s)
id=67 (not connected, accepting connect from 192.168.0.102)
id=68 (not connected, accepting connect from 192.168.0.102)
...
id=1	@192.168.0.102  (RonDB-21.04.5, Nodegroup: 0, *)
id=2	@192.168.0.102  (RonDB-21.04.5, Nodegroup: 0)
id=3	@192.168.0.102  (RonDB-21.04.5, Nodegroup: 0)
