...
IF(NOT CPACK_SOURCE_PACKAGE_FILE_NAME)
  ...
  IF(WITH_NDBCLUSTER)
    SET(CPACK_SOURCE_PACKAGE_FILE_NAME "rondb-gpl-${MYSQL_CLUSTER_VERSION}")
    MESSAGE(STATUS "RonDB Cluster package name: ${CPACK_SOURCE_PACKAGE_FILE_NAME}")
  ELSE()
  ENDIF()
ENDIF()
SET(CPACK_PACKAGE_CONTACT "Hopsworks AB <mikael@hopsworks.ai>")
SET(CPACK_PACKAGE_VENDOR "Hopsworks AB")
